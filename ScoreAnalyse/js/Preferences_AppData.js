...
const PreferencesAppData = {
  ...
  , thiness_cellule_line:   {type:'inputtext'   ,typeV:'number'   ,default:5        ,label:"Grosseur trait cellules"        ,unite:'px' ,selector:'div.amark.cel'   ,selector_value:'border-width:__VALUE__px;'}
