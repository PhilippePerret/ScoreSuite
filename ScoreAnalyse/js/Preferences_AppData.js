...
const PreferencesAppData = {
  ...
  , snap_for_adjust_pos:    {type:'inputtext'   ,typeV:'number'   ,default:50       ,label:"Distance de magnétisme pour ajustement des marques", precision:"Affect les marques de même type et seulement si la préférence “Ajuster en hauteur” ci-dessus est activée."}
  ...
  , marque_texte_size_1:    {type:'inputtext'   ,typeV:'number'   ,default:70       ,label:"Taille des gros textes",   unite:'px', selector:'div.amark.txt.size1 span.content',   selector_value:'font-size:__VALUE__px;'}
  , marque_texte_size_2:    {type:'inputtext'   ,typeV:'number'   ,default:50       ,label:"Taille des textes moyens", unite:'px', selector:'div.amark.txt.size2 span.content', selector_value:'font-size:__VALUE__px;'}
  , marque_texte_size_3:    {type:'inputtext'   ,typeV:'number'   ,default:30       ,label:"Taille des petits textes", unite:'px', selector:'div.amark.txt.size3 span.content', selector_value:'font-size:__VALUE__px;'}
